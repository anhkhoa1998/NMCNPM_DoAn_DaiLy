Public Class MainFrm
    Private Sub ThêmĐạiLýToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ThêmĐạiLýToolStripMenuItem.Click
        ThemDaiLyFrm.Show()
    End Sub
    ...
    Private Sub QuảnLýMặtHàngToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QuảnLýMặtHàngToolStripMenuItem.Click
        QuanLyMatHangFrm.Show()
    End Sub
    ...
    Private Sub ThêmĐơnVịTínhToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ThêmĐơnVịTínhToolStripMenuItem.Click
        ThemDonViTinhFrm.Show()
    End Sub

    Private Sub QuảnLýĐơnVịTínhToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QuảnLýĐơnVịTínhToolStripMenuItem.Click
        QuanLyDonViTinh.Show()
    End Sub
    ...
    Private Sub ThêmChiTiếtPhiếuXuấtToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ThêmChiTiếtPhiếuXuấtToolStripMenuItem.Click
        ThemChiTietPhieuXuat.Show()
    End Sub

    Private Sub QuảnLýChiTiếtPhiếuXuấtToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QuảnLýChiTiếtPhiếuXuấtToolStripMenuItem.Click
        QuanLyChiTietPhieuXuatFrm.Show()
    End Sub

    Private Sub ThêmPhiếuThuToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ThêmPhiếuThuToolStripMenuItem.Click
        ThemPhieuThuTien.Show()
    End Sub

    Private Sub QuảnLýPhiếuThuToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QuảnLýPhiếuThuToolStripMenuItem.Click
        QuanLyPhieuThuTien.Show()
    End Sub
End Class
